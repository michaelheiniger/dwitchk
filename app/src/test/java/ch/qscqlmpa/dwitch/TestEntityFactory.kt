...
class TestEntityFactory {
    ...
    companion object {
        ...
        fun createGameInGameRoom(localPlayerId: PlayerInGameId = PlayerInGameId(100)): Game {
            ...
            val gameState = GameBootstrap.createNewGame(
                players, localPlayerId, RandomInitialGameSetup(players.size)
            )
        ...
        fun createGameState(localPlayerId: PlayerInGameId = PlayerInGameId(100)): GameState {
            val players = listOf(createHostPlayer(), createGuestPlayer1(), createGuestPlayer2())
                .map(Player::toPlayerInfo)
            return GameBootstrap.createNewGame(
                players,
                localPlayerId,
