...
internal class CardExchangeComputerTest {
    ...
    fun `President must choose 2 cards`() {
        val cardExchange = CardExchangeComputer.getCardExchange(playerId, Rank.President, someCards)
        assertThat(cardExchange!!.numCardsToChoose).isEqualTo(2)
    }

    @Test
    fun `Vice-President must choose 1 card`() {
        val cardExchange = CardExchangeComputer.getCardExchange(playerId, Rank.VicePresident, someCards)
        assertThat(cardExchange!!.numCardsToChoose).isEqualTo(1)
    }

    @Test
    fun `Vice-Asshole must choose 1 card`() {
        val cardExchange = CardExchangeComputer.getCardExchange(playerId, Rank.ViceAsshole, someCards)
        assertThat(cardExchange!!.numCardsToChoose).isEqualTo(1)
    }

    @Test
    fun `Asshole must choose 2 cards`() {
        val cardExchange = CardExchangeComputer.getCardExchange(playerId, Rank.Asshole, someCards)
        assertThat(cardExchange!!.numCardsToChoose).isEqualTo(2)
    }

    @Test
    fun `Neutral players don't perform any card exchange`() {
        val cardExchange = CardExchangeComputer.getCardExchange(playerId, Rank.Neutral, someCards)
    ...
    fun `President can choose any of its cards`() {
        ...
        val cardExchange = CardExchangeComputer.getCardExchange(playerId, Rank.President, cards)
    ...
    fun `Vice-President can choose any of its cards`() {
        ...
        val cardExchange = CardExchangeComputer.getCardExchange(playerId, Rank.VicePresident, cards)
    ...
    fun `Asshole must choose the 2 cards with the highest value - twice same value`() {
        ...
        val cardExchange = CardExchangeComputer.getCardExchange(playerId, Rank.Asshole, cards)
    ...
    fun `Vice-Asshole must choose the card with the highest value`() {
        ...
        val cardExchange = CardExchangeComputer.getCardExchange(playerId, Rank.ViceAsshole, cards)
